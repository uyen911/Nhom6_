...
--    Ngay datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
--    CONSTRAINT PK_Revenues PRIMARY KEY (MaSP, Ngay),
--    CONSTRAINT FK_Revenues_SanPham FOREIGN KEY (MaSP) REFERENCES SanPham(MaSP)
--);
--go
--INSERT INTO Revenues (MaSP, DoanhSo)
--VALUES ('ALBSP01', 500000), ('ALBSP02', 700000), ('ALBSP03', 600000);
