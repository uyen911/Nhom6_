...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
	<div>
<h2 class="fw-bolder mb-4 tenSP-ls-h3" style="margin-top:7.5rem;"><%--Related products--%> <p class="tenSP-ls-p">Xóa Tài Khoản</p></h2>
            <style>
                .tenSP-ls-h3 {
        ...
        #btDel:hover,.btn-del:hover {
            ...
            </style>			<span style="color:black;">Email: <b>
			<asp:Label ID="lbDeptid" runat="server" Text=""  style="color:black;"></asp:Label></b></span>
		<div></div>
		<span  style="color:black;">Mật Khẩu: <asp:Label ID="lbName" runat="server"  style="color:black;"
			Text="1"></asp:Label></span>
	</div>
		<asp:Button ID="btDel" runat="server" Text="Xóa" OnClick="btDel_Click"  style="color:black;" CssClass="btn-del" />
