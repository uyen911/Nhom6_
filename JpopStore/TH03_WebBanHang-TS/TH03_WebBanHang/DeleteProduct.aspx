<%@ Page Title="JPopStore" Language="C#" MasterPageFile="~/Shop.Master" AutoEventWireup="true" CodeBehind="DeleteProduct.aspx.cs" Inherits="TH03_WebBanHang.DeleteProduct" %>
...
<h2 class="fw-bolder mb-4 tenSP-ls-h3"style="margin-top:7.5rem;"><%--Related products--%> <p class="tenSP-ls-p">Xóa Sản Phẩm</p></h2>
        ...
        <asp:Label ID="lbMaSPV" Visible="false" runat="server" Text="" style="color:black;"></asp:Label></b></span>

        <span style="color:black;">Mã Sản Phẩm: <b>
			<asp:Label ID="lbDeptid" runat="server" Text="" style="color:black;"></asp:Label></b></span>
		<div></div>
		<span style="color:black;">Tên Sản Phẩm: <asp:Label ID="lbName" runat="server" style="color:black;"
