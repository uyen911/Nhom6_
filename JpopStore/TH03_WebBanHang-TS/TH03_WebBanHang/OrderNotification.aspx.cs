...
namespace TH03_WebBanHang
{
    public partial class OrderNotification : System.Web.UI.Page
    {
        ...
        //            SendEmail(user.Email, "JPopStore", madh, imagePath);
        //        });
        //    }
        //    else lbMaDH.Text = "";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (maDH != null)
            {
                ...
                lbMaDon.Text = maDH.MaDH;
                string madh = lbMaDon.Text;
                Session["MailMD"] = madh;
                string email = SignIn.email;
                lbMail.Text = email;
                var db = new QL_JPOPStoreEntities();
