...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
	...
	<h1 class="fw-bolder mb-4 tenSP-ls-h3">
		<p class="tenSP-ls-p">Thành Viên Nhóm</p>
	</h1>
	<link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet" />
	<style>
		.tenSP-ls-h3 {
		...
		<div class="row" style="margin-left:250px;">
			...
			<div class="col-12 col-sm-6 col-lg-3">
				<div class="single_advisor_profile wow fadeInUp" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
					...
					<div class="advisor_thumb">
						<img src="https://i.pinimg.com/736x/1d/e6/a8/1de6a87343236c698bd5e3bbc602a787.jpg" alt="">
						<!-- Social Info-->
			...
			<div class="col-12 col-sm-6 col-lg-3">
				<div class="single_advisor_profile wow fadeInUp" data-wow-delay="0.3s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInUp;">
					<!-- Team Thumb-->
					<div class="advisor_thumb">
						<img src="https://i.pinimg.com/736x/f5/1d/ee/f51dee402bd3594560a0e4639d35e733.jpg" alt="">
						<!-- Social Info-->
						<div class="social-info"><a href="#"><i class="fa fa-facebook"></i></a><a href="#"><i class="fa fa-twitter"></i></a><a href="#"><i class="fa fa-linkedin"></i></a></div>
					</div>
					<!-- Team Details-->
			...
			<div class="col-12 col-sm-6 col-lg-3">
				<div class="single_advisor_profile wow fadeInUp" data-wow-delay="0.4s" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInUp;">
					<!-- Team Thumb-->
					<div class="advisor_thumb">
						<img src="https://i.pinimg.com/736x/a2/c7/57/a2c7574a1891d64d53bc304f2aa5024b.jpg" alt="">
						<!-- Social Info-->
						<div class="social-info"><a href="#"><i class="fa fa-facebook"></i></a><a href="#"><i class="fa fa-twitter"></i></a><a href="#"><i class="fa fa-linkedin"></i></a></div>
					</div>
					<!-- Team Details-->
